					...
					<div className="flex items-center gap-2 justify-between w-full px-4 ">
						...
						<div className="flex gap-2">
							...
							<Button
								size="sm"
								variant="outline"
								className="bg-ucr-blue border-ucr-blue/40 text-white hover:text-white hover:bg-ucr-blue/80 dark:border-ucr-gold/40 dark:text-ucr-black dark:bg-ucr-gold/90 dark:hover:bg-ucr-gold"
							>
								Check Jobs
							</Button>
						</div>
