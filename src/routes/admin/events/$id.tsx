            ...
            {copied ? "Copied" : "Share"}
					...
					{event.organizationIds && event.organizationIds.length > 1 ? (
						<Button
							...
							onClick={() =>
								navigate({
									to: `/admin/organizations/${event.organizationIds?.[0]}`,
								})
							}
							className="border-ucr-blue/40 text-ucr-blue hover:bg-ucr-blue/10 dark:border-ucr-gold/40 dark:text-ucr-yellow"
						>
					...
					<div className="space-y-6">
						...
						<div className="space-y-4">
							...
							>
								<span>
									View on{" "}
									{event.source === "instagram" ? "Instagram" : "Source"}
								</span>
							...
							<div>
								...
								<div className="text-sm text-muted-foreground space-y-2">
									...
									{event.organizationIds &&
										event.organizationIds.length > 0 && (
											<div>
				...
				{isEditMode && (
					<div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
						<p className="text-sm text-yellow-800 dark:text-yellow-200">
							...
							event fields, update metadata, and save changes.
						</p>
					</div>
				)}
			</div>
