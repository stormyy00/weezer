	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-gray-50 dark:bg-[#0a0a0a] relative">
			<div className="grid grid-cols-1 md:grid-cols-2 items-center  w-full">
				<div className="hidden md:block w-full bg-ucr-blue min-h-screen relative z-0 overflow-hidden"></div>
				<div className="flex flex-col items-center justify-center max-w-md mx-auto m-4">
					<h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">
						Admin Login
					</h2>
					<p className="mb-6">
						Login to access the admin panel. If you are not an admin, please
						return to the{" "}
